package com.artlighter.glucosecontrolservice.authgateway.controller.templates;
...
//    }
    ...
    public CarbsResult calculateCarbs(@PathVariable int userId, @RequestBody Map<String, Float> mealWeights) {
        ...
        return new CarbsResult((float) patientProfile.getCarbsUnit().convertFromGrams(overallCarbs),
