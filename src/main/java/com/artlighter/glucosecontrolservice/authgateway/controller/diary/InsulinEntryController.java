...
public class InsulinEntryController extends AbstractDiaryEntryController<InsulinEntry, InsulinEntryDTO> {
    ...
    @Override
    @Operation(summary = "Получить записи с вводами инсулина за временной период (постранично).",
    ...
    @GetMapping("/insulin")
    public CustomSlicedModel<InsulinEntryDTO> getDiaryEntries(int userId, Instant from, Instant to,
