...
public class ExceptionOutputUtils {
    ...
    public static ExceptionDTO createValidationException(ConvertableValueValidationException ex, Errors errors,
                                                         String rejectedFieldName) {
        errors.rejectValue(rejectedFieldName, "not_in_range", ex.getMessage());
        return createException(HttpStatus.BAD_REQUEST, errors, ex.getMessage());
    }
